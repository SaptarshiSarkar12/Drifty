...
> [!TIP]
> Drifty is released in 4 phases - **Alpha**, **Beta**, **Release Candidate**, and **Stable**.
> If you want to test the unstable (**Alpha** or **Beta**) or the partially stable versions (**Release Candidate**), you can click on the download button of the respective phase.
