...
export default function MainSection() {
    return (
        <div className="flex flex-row-1 bg-top space-evenly md:justify-center xs:justify-start">
            ...
            <div className="hidden flex-col-1 md:block text-center text-gray-800 py-20 px-6 img-layer w-1/2" id="ImgLayer">
                <Image width={256} height={0} className=" -mt-28" src="/Resources/Layers/2.webp" alt="..." />
                <Image width={256} height={0} src="/Resources/Layers/3.webp" alt="..." srcset="" />
                <Image width={256} height={0} src="/Resources/Layers/4.webp" alt="..." />
                <Image width={256} height={0} src="/Resources/Layers/5.webp" alt="..." />
                <Image width={256} height={0} src="/Resources/Layers/6.webp" alt="..." />
                <Image width={256} height={0} src="/Resources/Layers/7.webp" alt="..." />
            </div>
        </div>
