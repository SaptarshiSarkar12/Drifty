        ...
        <div className={"select-none"}>
            ...
            <div className="bg-gradient-to-b from-top from-18% via-about via-12% to-bottom to-12%">
                ...
                <div className="grid justify-center xs:pl-3 sm:pl-16">
                    <a className="sm:pl-20 place-self-center sm:place-self-auto xs:place-self-center sm: pt-4 font-bold" href="https://bio.link/saptarshi">Saptarshi Sarkar</a>
                ...
                <div className="mt-5 mx-5 border-t-2 border-black">
                    ...
                    <div className="grid w-auto h-auto lg:grid-cols-3  lg:-space-x-25 justify-items-center py-5 pb-20 md:grid-cols-1">
