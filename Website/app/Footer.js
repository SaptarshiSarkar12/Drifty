            ...
            <footer className="p-4 bg-bottom sm:p-6">
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    ...
                    <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                        ...
                        <a href="https://www.linkedin.com/in/saptarshisarkar12/" className="text-gray-500 hover:text-linkedin-color hover:transition ease-in-out duration-300 delay-100 hover:-translate-y-1 hover:scale-110">
