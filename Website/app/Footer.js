        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          ...
          <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
            <a
              ...
              className="text-gray-500 hover:text-black hover:transition ease-in-out duration-300 delay-100 hover:-translate-y-1 hover:scale-110"
            >
              <svg
                className="w-5 h-5"
                fill="currentColor"
            ...
            <a
              ...
              className="text-gray-500 hover:text-linkedin-color hover:transition ease-in-out duration-300 delay-100 hover:-translate-y-1 hover:scale-110"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="currentColor"
            ...
            <a
              ...
              className="text-gray-500 hover:text-hashnode-color hover:transition ease-in-out duration-300 delay-100 hover:-translate-y-1 hover:scale-110"
            >
              <svg
                className="w-5 h-5"
                fill="currentColor"
            ...
            <a
              ...
              className="text-gray-500 hover:text-violet-700 hover:transition ease-in-out duration-300 delay-100 hover:-translate-y-1 hover:scale-110"
            >
