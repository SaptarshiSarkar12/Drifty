    ...
    return (
        <div id="contribute" className="md:grid md:grid-cols-2 justify-center bg-var select-none text-white pb-5">
            ...
            <div className="ml-2">
                ...
                <div className="flex items-center justify-center gap-[2em] flex-wrap rounded-full space-x-0 gap-y-4 justify-items-center xs:pb-10 ">
                ...
                <div className="grid grid-cols-3 justify-items-center text-lg font-semibold pr-3 space-x-3 mt-4">
                    <a className="rounded-lg w-auto lg:w-48 border-2 md:border-white text-center hover:text-black xs:transition ease-in-out delay-100 bg-blue-500 hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 duration-300" href="https://github.com/SaptarshiSarkar12/Drifty"><i aria-hidden="true" className="fab fa-github p-3"></i>Contribute</a>
                    <a className="rounded-lg w-auto lg:w-48 border-2 md:border-white text-center hover:text-black xs:transition ease-in-out delay-100 bg-blue-500 hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 duration-300" href="https://github.com/SaptarshiSarkar12/Drifty/stargazers"><i aria-hidden="true" className="fa fa-regular fa-star p-3"></i>Stars : {values[0]}</a>
                    <a className="rounded-lg w-auto lg:w-48 border-2 md:border-white text-center hover:text-black xs:transition ease-in-out delay-100 bg-blue-500 hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 duration-300" href="https://github.com/SaptarshiSarkar12/Drifty/network/members"><i aria-hidden="true" className="fa fa-duotone fa-code-fork p-3"></i>Forks : {values[1]}</a>
                </div>
            </div>
        </div>
    )
