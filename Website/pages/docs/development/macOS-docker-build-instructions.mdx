...
<details>
  ...
  telling it what your local IP address is. > > On most home networks, the
  typical setup is to have a router where your computer is connected to the LAN
  ...
  Internet and don't look back. > > We, however, need to look back... > >
  ...
  access the Internet, etc. > > DHCP services are also designed to make that
