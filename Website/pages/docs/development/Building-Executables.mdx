...
<Callout type="info">
  This step is required only if you want to see your code changes reflected in Drifty
  CLI or GUI executables. If you are only interested to know the process of building the installer
...
<Tabs.Tab>
     - For Linux and Windows users,
       ...
       - Run the below command to build and start the Drifty GUI native executable in a Docker container
         ...
         ```
     - For macOS users, please follow [these instructions](macOS-docker-build-instructions.mdx)
</Tabs.Tab>
<Tabs.Tab>
