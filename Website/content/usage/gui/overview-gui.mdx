...
Drifty GUI automatically checks for updates when you start the application. If a new version is available, a popup will appear with the option to update to the latest version. By clicking on the **Yes** button, Drifty GUI will download the latest version and install it automatically. You will need to restart the application to apply the update.
