import ThemeImage from '../../components/docs/ThemeImage'
...
<ThemeImage
  lightSrc="/docs_images/drifty-architecture-light.svg"
  darkSrc="/docs_images/drifty-architecture-dark.svg"
  alt="Drifty Architecture Diagram"
  width="800"
  height="500"
/>
