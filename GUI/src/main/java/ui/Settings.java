...
public class Settings {
    ...
    private void setupThemeChoice() {
        ...
        themeChoiceBox.setOnAction(e -> Theme.applyTheme(themeChoiceBox.getValue().equals("Dark Theme") ? "Dark" : "Light", settingsScene, Drifty_GUI.getScene(), About.getScene(), UIController.infoScene, ConfirmationDialog.getScene()));
    }
